...
--
-- Host: 127.0.0.1
-- Generation Time: May 08, 2026 at 05:47 PM
...
(38, NULL, 'kd1e8esfh1hokmsh7h6aa9vfur', 1, 1, '2026-05-08 15:14:55'),
...
(24, NULL, 'sondos', 'yaseen', 'sondos.yaseen@gmail.com', '0598352860', 'kkl', 6110.00, 50.00, 305.50, 5854.50, 'pending', '2026-05-08 14:56:28'),
(25, NULL, 'sondos', 'yaseen', 'sondos.yaseen85@gmail.com', '0598352860', 'kilo', 7800.00, 50.00, 390.00, 7460.00, 'pending', '2026-05-08 14:58:56'),
(26, 1, 'sondos', 'yaseen', 'sondos.yaseen@gmail.com', '0598352860', 'kilo', 4100.00, 50.00, 205.00, 3945.00, 'pending', '2026-05-08 15:39:30');
...
(6, 25, 7, 'ثوب ملكي من حيفا', 1, 2800.00),
(7, 25, 8, 'برقع + عرجة', 1, 2500.00),
(8, 25, 6, 'ثوب فلسطيني تقليدي', 1, 2500.00),
...
(2, 'وشاح حرير مزخرف', 'وشاح من الحرير الطبيعي الناعم، يتميز بألوان زاهية وزخارف نباتية دقيقة، مثالي لإطلالة راقية وعصرية بلمسة تراثية.', 1200.00, 'images/item2.png', 'andalus', 11, '2026-05-07 11:08:26', 'اكسسوارات'),
(3, 'مصباح نحاسي تراثي', 'قطعة فنية مشغولة يدوياً من النحاس الخالص، تعكس ظلالاً ساحرة وتضفي أجواءً من الدفء والأصالة على زوايا منزلك.', 450.00, 'images/item3.png', 'andalus', 28, '2026-05-07 11:08:26', 'ديكور'),
...
(6, 'ثوب فلسطيني تقليدي', 'قطعة تراثية فريدة تجسد الهوية الفلسطينية، مطرزة يدوياً بدقة عالية وبألوان كلاسيكية تعكس عراقة الماضي وأصالة الحرفة.', 2500.00, 'images/item11.png', 'sham', 10, '2026-04-23 08:01:26', 'ملابس'),
(7, 'ثوب ملكي من حيفا', 'تصميم فاخر مستوحى من جمال مدينة حيفا، يتميز بقصات ملكية وتفاصيل تطريز غنية تجعل منه خياراً مثالياً للمناسبات الكبرى والباحثات عن التميز.', 2800.00, 'images/item12.png', 'sham', 6, '2026-05-07 11:08:26', 'ملابس'),
(8, 'برقع + عرجة', 'طقم إكسسوارات تراثي يجمع بين \"العرجة\" المزدانة بالقطع المعدنية والبرقع التقليدي، لإضافة لمسة أصيلة وجمالية على الزي الشعبي', 2500.00, 'images/item13.png', 'sham', 3, '2026-05-07 11:08:26', 'اكسسوارات'),
...
(16, 'فستان الكالاسيريس الفرعوني', 'ثوب أيقوني مستوحى من أزياء ملكات النيل، يتميز بقصته الانسيابية الطويلة التي تمنح القوام رشاقة ومظهراً مهيباً، مصنوع من قماش خفيف يحاكي الكتان المصري الفاخر.', 1100.00, 'images/item31.png', 'egypt', 14, '2026-05-07 11:08:26', 'ملابس'),
(17, 'الصديرية الذهبية مع الخرز الأزرق', 'قطعة مجوهرات عريضة (Wesekh) تعكس بريق الشمس، مرصعة بخرز يحاكي لون \"اللازورد\" الملكي، صممت لتوضع فوق الأكتاف لتضيف لمسة من العظمة الفرعونية على أي زي.', 2200.00, 'images/item32.png', 'egypt', 9, '2026-05-07 11:08:26', 'اكسسوارات'),
...
(19, 'قلادة التعويذة الفرعونية', 'قلادة بتصميم تعويذة عين حورس الأصيلة,تتميز بتصميم دائري متناغم يرمز للأبدية، وهي قطعة مثالية للارتداء اليومي مع الحفاظ على روح التراث.', 700.00, 'images/item34.png', 'egypt', 7, '2026-05-07 11:08:26', 'اكسسوارات'),
...
(21, 'صندوق مجوهرات فاخر', 'صندوق خشبي مطعم بالصدف أو النحاس، مبطن من الداخل بالمخمل لحفظ مقتنياتك الثمينة بأناقة وأمان.', 980.00, 'images/item6.png', 'andalus', 13, '2026-05-07 11:08:26', 'ديكور'),
