...
(16, NULL, 'kd1e8esfh1hokmsh7h6aa9vfur', 14, 5, '2026-05-08 00:03:08');
...
(6, 'مجموعة أواني نحاسية مخرمة', 'طقم من النحاس الخالص المشغول يدوياً بدقة، يتميز بنقوش مخرمة تسمح بمرور الضوء والظل، مما يجعله قطعة تقديم وديكور استثنائية.', 1500.00, 'images/item17.png', 'sham', 11, '2026-04-23 08:01:26', 'ديكور'),
(7, 'ثوب ملكي من حيفا', 'تصميم فاخر مستوحى من جمال مدينة حيفا، يتميز بقصات ملكية وتفاصيل تطريز غنية تجعل منه خياراً مثالياً للمناسبات الكبرى والباحثات عن التميز.', 2800.00, 'images/item12.png', 'sham', 7, '2026-05-07 11:08:26', 'ملابس'),
(8, 'برقع + عرجة', 'طقم إكسسوارات تراثي يجمع بين \"العرجة\" المزدانة بالقطع المعدنية والبرقع التقليدي، لإضافة لمسة أصيلة وجمالية على الزي الشعبي', 2500.00, 'images/item13.png', 'sham', 4, '2026-05-07 11:08:26', 'اكسسوارات'),
